    ...
    <div id="app">
        ...
        <main class="container py-4">
            ...
            <div class="row">
              <div class="col-md-4">
                @auth
                <a href="{{ route('products.create') }}" style="width:100%" class="btn btn-info my-2">Add Product</a>
                @else
                <a href="{{ route('login') }}" style="width:100%" class="btn btn-info my-2">Sign in to add Product</a>
                @endauth
                <div class="card">
