                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        <a href="#">
                                            <img src="{{ asset('storage') }}/{{ $product->model->image }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" style="max-width: 10vw;">
                                        </a>
                                ...
                                <td class="product-subtotal">
                                    <h5 class="total amount">${{ $product->price*$product->qty }}</h5>
                                </td>
